...
def create_strike_probe(selections):
    ...
    for palnum in pallet:        
        if s_or_p == 'Striking':
            ...
            createPalletProbe(cust_name, cust_part_num, jobnum, palnum, stations, machine, mod_X_dim, mod_Y_dim, offset_x, offset_y,probepath, man_x, man_y, glass_thick,skew_check,probe_corner,orientation)
    #return 'Success'    
...
def createPalletProbe(cust_name, cust_part_num, jobnum, palnum, stations, machine, mod_X_dim, mod_Y_dim, offset_x, offset_y,probepath, man_x, man_y, glass_thick,skew_check,probe_corner,orientation):
    probing_program = ''
